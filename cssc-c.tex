...
\begin{document}
                ...
                \subsection{Marketing Officer}
                         \begin{enumarate}[label=\alph*]
                                ...
                                \item Possess credential access to all relevant social media accounts, at the President's discretion
                                 \item Act within the foremost capacity to promote and advertise the club, fully, to all who could be involved with CSSC
            \end{enumarate} 
	...
	\chapter{Miscellaneous}
		\section{History of Versions}
			2017 - The constitution was rewritten from scratch by President Anton Savill from a proposed 2012 version and the version that was put together by the 2015 committee when it was found that guild didn't have a copy of our actual constitution.
			2018 - Modifications to the constitution from 1.0.2.0 to 1.0.5.0 Proposed by President Ki Savill
