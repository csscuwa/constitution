...
\begin{document}
	...
	\section{Membership}
		...
		\subsection{Honorary Life Memberships}
            ...
            The Club may in General Meeting, by three-quarters of those present and voting remove Honorary Life Memberships upon an Honorary Life Memeber.
	...
	In addition to any provisions set out elsewhere in this constitution or in any by laws or Regulations made hereunder, committee positions shall have the duty of:
		...
		\subsection{Marketing Officer}
            \begin{enumerate}[label=\alph*]
                \item Orangise and manage the club's social media platforms.
		...
		\subsection{Ordinary Committee Members}
			...
			\end{enumerate}
pd
		\subsection{Gender Equity Representative}
			\begin{enumerate}[label=\alph*]
